...
prayerMedia.Firebase = class {
  ...
  getComments(postId) {
    return this._getPaginatedFeed(`/comments/${postId}`,
        prayerMedia.Firebase.COMMENTS_PAGE_SIZE, null, false);
  }
   ...
   */
  getPosts() {
    return this._getPaginatedFeed('/posts/', prayerMedia.Firebase.POSTS_PAGE_SIZE);
  }
  ...
  getHomeFeedPosts() {
    return this._getPaginatedFeed(`/feed/${this.auth.currentUser.uid}`,
        prayerMedia.Firebase.POSTS_PAGE_SIZE, null, true);
  }
  ...
  getUserFeedPosts(uid) {
    return this._getPaginatedFeed(`/people/${uid}/posts`,
        prayerMedia.Firebase.USER_PAGE_POSTS_PAGE_SIZE, null, true);
  }
...
prayerMedia.firebase = new prayerMedia.Firebase();
